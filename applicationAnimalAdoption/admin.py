...
from .models import Animals, Owners, HealthRecords
...
@admin.register(HealthRecords)
class HealthRecordsAdmin(admin.ModelAdmin):
    list_display = ("animal_id", "diagnosis", "veterinarian", "treatment", "chipped", "vaccinated")
